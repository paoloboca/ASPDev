...
function refreshDiagnostics(doc, errorDiagnostics) {
    ...
    if (regex.test(doc.fileName)) {
        ...
        for (let lineIndex = 0; lineIndex < doc.lineCount; lineIndex++) {
            ...
            const [global_head, global_tail, global_negative, global_expression, global_before_equal, local_head_aggregate, local_negative, local_positive, local_expressions, local_equals] = (0, parsing_1.tokenize_head_tail)(constructs, atoms, lineOfText);
            const result = (0, parsing_1.checkSafe)(global_head, global_tail, global_negative, global_expression, global_before_equal, local_head_aggregate, local_negative, local_positive, local_expressions, local_equals);
...
/*
Genera un oggetto diagnostico per Visual Studio Code per segnalazioni specifiche legate a commenti di fine riga o test nel codice,
contrassegnati da /%% o **%. Identifica il punto di inizio del commento o del test nella linea di testo e imposta
l'intervallo diagnostico da quel punto fino alla fine della linea.
*/
...
//# sourceMappingURL=LogicAndSyntax_checking.js.map