...
const syntax_checking_test_1 = require("./syntax_checking_test");
...
function refreshDiagnostics(doc, errorDiagnostics) {
    ...
    const atoms = [];
    let opened = false;
    const testBlocks = (0, syntax_checking_test_1.getLinesInTestBlock)(doc);
...
function isLineInTestBlock(lineIndex, testBlocks) {
...
//# sourceMappingURL=syntax_checking_asp.js.map