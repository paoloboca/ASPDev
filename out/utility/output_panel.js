...
class OutputPanel {
    ...
    createPanel() {
        this.panel = vscode.window.createWebviewPanel('outputPanel', 'Output Panel', vscode.ViewColumn.Beside, {
            enableScripts: true
        });
    ...
    appendOutputToContent(currentContent, newOutput) {
    ...
    getWebviewContent(initialContent, output) {
        return `<!DOCTYPE html>
        <html lang="en">
        <head>
            <meta charset="UTF-8">
...
//# sourceMappingURL=output_panel.js.map