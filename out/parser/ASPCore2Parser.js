...
class ASPCore2Parser extends Parser_1.Parser {
    ...
    static TIMES = 18;
    static SLASH = 19;
    static BACK_SLASH = 20;
    static PARAM_OPEN = 21;
    static PARAM_CLOSE = 22;
    static SQUARE_OPEN = 23;
    static SQUARE_CLOSED = 24;
    static CURLY_OPEN = 25;
    static CURLY_CLOSE = 26;
    static QUERY_MARK = 27;
    static ANON_VAR = 28;
    static EQUAL = 29;
    static UNEQUAL = 30;
    static LESS = 31;
    static GREATER = 32;
    static LESS_OR_EQ = 33;
    static GREATER_OR_EQ = 34;
    static AMPERSAND = 35;
    static EXISTS = 36;
    static AGGR_COUNT = 37;
    static AGGR_MAX = 38;
    static AGGR_MIN = 39;
    static AGGR_SUM = 40;
    static ANNOTATION_GLOBAL_WASP_PROPAGATOR = 41;
    static DIRECTIVE_NAME = 42;
    static DIRECTIVE_VALUE = 43;
    static ANNOTATION_RULE_ALIGN_SUBSTITUTIONS = 44;
    static ANNOTATION_RULE_LOOK_AHEAD = 45;
    static ANNOTATION_RULE_PROJECTION = 46;
    static ANNOTATION_RULE_REWRITING_ARITH = 47;
    static ANNOTATION_RULE_ORDERING = 48;
    static ANNOTATION_ORDERING_VALUE = 49;
    static ANNOTATION_RULE_ATOM_INDEXED = 50;
    static ANNOTATION_ATOM_INDEXED_ATOM = 51;
    static ANNOTATION_ATOM_INDEXED_ARGUMENTS = 52;
    static ANNOTATION_RULE_PARTIAL_ORDER = 53;
    static ANNOTATION_PARTIAL_ORDER_BEFORE = 54;
    static ANNOTATION_PARTIAL_ORDER_AFTER = 55;
    static ANNOTATION_EXTATOM_PREDICATE = 56;
    static ANNOTATION_EXTATOM_TYPE = 57;
    static ANNOTATION_EXTATOM_TYPE_QCONST = 58;
    static ANNOTATION_EXTATOM_TYPE_CONST = 59;
    static ANNOTATION_EXTATOM_TYPE_U_INT = 60;
    static ANNOTATION_EXTATOM_TYPE_UR_INT = 61;
    static ANNOTATION_EXTATOM_TYPE_UT_INT = 62;
    static ANNOTATION_EXTATOM_TYPE_R_INT = 63;
    static ANNOTATION_EXTATOM_TYPE_T_INT = 64;
    static ANNOTATION_GLOBAL_ORDERING = 65;
    static ANNOTATION_GLOBAL_ATOM_INDEXED = 66;
    static ANNOTATION_GLOBAL_PARTIAL_ORDER = 67;
    static ANNOTATION_GLOBAL_EXTATOM_CONVERSION = 68;
    static ANNOTATION_RULE_TO_DECOMPOSE = 69;
    static ANNOTATION_RULE_TO_NOT_DECOMPOSE = 70;
    static ANNOTATION_GLOBAL_WASP_HEURISTIC = 71;
    static ANNOTATION_GLOBAL_WASP_HEURISTIC_FILE = 72;
    static ANNOTATION_GLOBAL_WASP_HEURISTIC_ELEMENTS = 73;
    static START_TEST = 74;
    static END_TEST = 75;
    static START_COMMENT = 76;
    static END_COMMENT = 77;
    static COMMENT = 78;
    ...
    static _serializedATNSegment0 = "\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x03P\u03FC\x04\x02" +
